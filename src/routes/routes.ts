...
const models: TsoaRoute.Models = {
    "ActiveSession": {
        ...
        "properties": {
            ...
            "createdByIp": {"dataType":"string","required":true},
    ...
    "Session": {
        ...
        "properties": {
            ...
            "user": {"ref":"SessionUser","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "z.infer_typeofloginSchema_": {
        "dataType": "refAlias",
    ...
    "LoginUserRequest": {
        "dataType": "refAlias",
        "type": {"ref":"z.infer_typeofloginSchema_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "z.infer_typeofregisterUserSchema_": {
        "dataType": "refAlias",
    ...
    "RegisterUserRequest": {
        "dataType": "refAlias",
        "type": {"ref":"z.infer_typeofregisterUserSchema_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UserIndex": {
        "dataType": "refObject",
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "z.infer_typeofchangePasswordSchema_": {
        "dataType": "refAlias",
    ...
    "ChangePasswordRequest": {
        "dataType": "refAlias",
        "type": {"ref":"z.infer_typeofchangePasswordSchema_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/auth/sessions',
            ...
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.getActiveSessions)),

            function AuthController_getActiveSessions(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getActiveSessions.apply(controller, validatedArgs as any);
        ...
        app.post('/auth/sessions/revoke-all',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.revokeAllSessions)),

            function AuthController_revokeAllSessions(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
            ...
            try {
              ...
              const promise = controller.revokeAllSessions.apply(controller, validatedArgs as any);
        ...
        app.get('/instruments/search',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(InstrumentController)),
            ...(fetchMiddlewares<RequestHandler>(InstrumentController.prototype.searchInstruments)),

            function InstrumentController_searchInstruments(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.searchInstruments.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/instruments/quote/:symbol',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(InstrumentController)),
            ...(fetchMiddlewares<RequestHandler>(InstrumentController.prototype.getQuote)),

            function InstrumentController_getQuote(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getQuote.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/session/refresh-token',
            ...(fetchMiddlewares<RequestHandler>(SessionController)),
            ...(fetchMiddlewares<RequestHandler>(SessionController.prototype.refreshToken)),

            function SessionController_refreshToken(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
        ...
        app.post('/session/logout',
            ...(fetchMiddlewares<RequestHandler>(SessionController)),
            ...(fetchMiddlewares<RequestHandler>(SessionController.prototype.logout)),

            function SessionController_logout(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
